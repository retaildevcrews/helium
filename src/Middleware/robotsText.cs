    ...
    public static class RobotsMiddlewareExtensions
    {
        ...
        public static IApplicationBuilder UseRobots(this IApplicationBuilder builder)
        {
            ...
            builder.Use(async (context, next) =>
            {
                ...
                if (!path.Contains("/", System.StringComparison.OrdinalIgnoreCase) && path.StartsWith("robots", System.StringComparison.OrdinalIgnoreCase) && path.EndsWith(".txt", System.StringComparison.OrdinalIgnoreCase))
                {
                    // return the content
