...
>
> Note: You will encounter an unauthorized error creating the SP with a `Contributor` role or lower. Ensure you have `Owner` access to the account to create the SP.
